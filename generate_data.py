...
def generate_synthetic_data(num_records=2000):
    """
    Creates a list of random banking transactions and returns it as a DataFrame.
    """
...
# This part tells Python to run the code ONLY if this file is executed directly
if __name__ == "__main__":
    try:
        ...
        # 3. Save the data to the 'transaction_ledger' table
        # if_exists="replace" ensures we start with a fresh table every time
